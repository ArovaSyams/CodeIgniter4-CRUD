...
<div class="container">
    <div class="row">
        <div class="col-8">
            ...
            <form action="/anime/saves" method="post">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control <?= ($validation->hasError('key_visual')) ? 'is-invalid' : ''; ?>" id="key_visual" name="key_visual" value="<?= old('key_visual'); ?>">
                        <div id="judul" class="invalid-feedback">
